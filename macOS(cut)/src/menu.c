...
void menu(bool *is_menu, SDL_Renderer *ren){//, char *h_score) {
	...
	while (SDL_PollEvent(&event)) 
	{
		...
		//renderTextureWithout(renderText(h_score, "resource/text/ttf/PressStart2P-Regular.ttf", color1, 25, ren_mainplane),ren_mainplane, 355, 380);
        renderTexture(start, ren, 250, 700, 299, 79);
        renderTexture(exit, ren, 250, 800, 299, 79);
        if(!IS_SOUND_OFF) renderTexture(sound_on, ren, 300, 900, 84, 62);
        else renderTexture(sound_off, ren, 300, 900, 84, 62);
