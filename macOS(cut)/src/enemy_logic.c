    ...
    *on_display = temp_on_display;
    ...
    for (int i = 0; i < 4; i++) {
        for (int j = 0; j < 64; j++) {
            ...
            && (pack2[i] -> y_enemy  >= y && pack2[i] -> y_enemy <= y + 88)) 
            || ((pack2[i] -> x_enemy + j >= x &&  pack2[i] -> x_enemy + j <= x + 128)
            && (pack2[i] -> y_enemy >= y + 88 && pack2[i] -> y_enemy <= y + 120)))
            && pack2[i] -> on_display) {
                if (main_ship.hited) {
                    return;
                }
        ...
        for (int j = 0; j < 64; j++) {
            ...
            && (pack2[i] -> y_enemy + j >= y && pack2[i] -> y_enemy + j <= y + 88)) 
            || ((pack2[i] -> x_enemy >= x &&  pack2[i] -> x_enemy <= x + 128)
            && (pack2[i] -> y_enemy + j >= y + 88 && pack2[i] -> y_enemy + j <= y + 120)))
            && pack2[i] -> on_display) {
                if (main_ship.hited) {
                    return;
                }
