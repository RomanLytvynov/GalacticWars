...
unsigned int init_pack() {
    srand(time(NULL));
    if (score < 1000 && !packs_on_display[0]) {
        init_pack1();
        packs_on_display[0] = true;
    }
    if (score < 5000 && score > 1000) {
        switch (rand() % 2 + 1) {
            case 1:
                    if(!packs_on_display[0]) {
                        init_pack1();
                        packs_on_display[0] = true;
                    }
                    break;
            case 2:
                    if(!packs_on_display[1]) {
                        init_pack2();
                        packs_on_display[1] = true;
                    }
                    break;
        }
    }
    ...
    if(score < 10000 && score > 5000) {
        switch (rand() % 3 + 1) {
            ...
            case 2:
                    ...
                    break;
            case 3:
                    if(!packs_on_display[2]) {
                        init_pack3();
                        packs_on_display[2] = true;
                    }
                    break;
        }
    }
    if(score > 10000) {
        switch (rand() % 4 + 1) {
            ...
            case 3:
                    ...
                    break;
            case 4:
                    if(!packs_on_display[3]) {
                        init_pack4();
                        packs_on_display[3] = true;
                    }
                    break;
        }
    }
